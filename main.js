...
function updateCanvas(){
  ...
  document.getElementById('rooprekha_v2').innerHTML = 'Sketch To be Drawn: ' + sketch;
...
timer_counter=0
timer_check="Times Up! Try again next time"
}
if(timer_check=="Times Up! Try again next time"||answer_holder=="set"){
    timer_check=""
    answer_holder=""
    updateCanvas()
}
